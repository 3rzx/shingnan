<?php
/* Smarty version 3.1.28, created on 2016-09-12 18:56:45
  from "C:\xampp\htdocs\backend\web\view\beacon\beaconEdit.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.28',
  'unifunc' => 'content_57d689ed7a6d76_99641868',
  'file_dependency' => 
  array (
...
function content_57d689ed7a6d76_99641868 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
...
?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="status" class="selectpicker col-sm-9">
                                            <option value="0" <?php if ($_smarty_tpl->tpl_vars['beaconData']->value['status'] == 0) {?>select: selected<?php }?>>0 預設</option>
                                            <option value="1" <?php if ($_smarty_tpl->tpl_vars['beaconData']->value['status'] == 1) {?>select: selected<?php }?>>1 未佈置</option>
                                            <option value="2" <?php if ($_smarty_tpl->tpl_vars['beaconData']->value['status'] == 2) {?>select: selected<?php }?>>2 待確認</option>
                                            <option value="3" <?php if ($_smarty_tpl->tpl_vars['beaconData']->value['status'] == 3) {?>select: selected<?php }?>>3 已確認</option>
                                        </select>
                                    </div>
