<?php
/* Smarty version 3.1.28, created on 2016-09-13 10:42:04
  from "C:\xampp\htdocs\backend\web\view\common\menu.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.28',
  'unifunc' => 'content_57d7677c5eabe0_39753684',
  'file_dependency' => 
  array (
...
function content_57d7677c5eabe0_39753684 ($_smarty_tpl) {
?>
        ...
        <ul class="sidebar-menu">
            ...
            <li>
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="../controller/statisticController.php?action=viewLikeCount"><i class="fa fa-circle-o"></i>文青樣板使用資料統計</a></li>
                </ul>
            </li>
            <?php }?>
            <!-- <?php if ($_SESSION['user']['competence'] < 4) {?>
