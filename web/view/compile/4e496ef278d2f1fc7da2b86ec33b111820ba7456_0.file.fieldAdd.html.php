<?php
/* Smarty version 3.1.28, created on 2016-11-17 20:00:36
  from "/var/www/html/web/view/field/fieldAdd.html" */

if ($_smarty_tpl->smarty->ext->_validateCompiled->decodeProperties($_smarty_tpl, array (
  'has_nocache_code' => false,
  'version' => '3.1.28',
  'unifunc' => 'content_582d9be4ce5972_01350650',
  'file_dependency' => 
  array (
    '4e496ef278d2f1fc7da2b86ec33b111820ba7456' => 
    array (
      0 => '/var/www/html/web/view/field/fieldAdd.html',
      1 => 1478666235,
      2 => 'file',
    ),
  ),
...
function content_582d9be4ce5972_01350650 ($_smarty_tpl) {
?>
<!DOCTYPE html>
<html>
                                ...
                                <div class="box-body">
                                    ...
                                    <div id="fieldMapEnDiv" class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <img id="fieldMapEnImg" class="img-thumbnail" style="display:none" alt="場域地圖"/>
                                        </div>
                                    </div>
                                    <div id="fieldMapBgDiv" class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            ...
                                            <img id="fieldMapBgImg" class="img-thumbnail" style="display:none" alt="場域地圖"/>
                                        </div>
                                    </div>
                                </div>
