...
class News
{
    ...
    public function newsAdd($input)
    {
        ...
        if ($_SESSION['isLogin'] == false) {
            ...
            $sql = "INSERT INTO `article` (`articleId`, `title`,`preview`, `content`, `type`, `ctr`, `isDelete`, `lastUpdateTime`, `createTime`) VALUES (:articleId, :title, :preview, :content, '2', '0', '0', :lastUpdateTime, :createTime);";
